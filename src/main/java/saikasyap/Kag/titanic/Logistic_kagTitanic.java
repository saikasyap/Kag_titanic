...
/**
 * Created by saikasyap on 5/25/17.
 */
...
public class Logistic_kagTitanic {
...
// Converting string labels into indices.
        ...
        Normalizer normalizer = new Normalizer()
                .setInputCol("norm_features").setOutputCol("features") .setP(1.0);
        ...
        Pipeline pipeline = new Pipeline()
                .setStages( new PipelineStage[]{embarkedIndexer, sexIndexer, survivedIndexer, TitleIndexer , fareBucketize , embEncoder, sexEncoder, assembler,normalizer, lr} );
...
// processing the test data...
        ...
        Dataset<Row> predTest = model.transform( InptestDf );
...
// Have a got a score of 0.76/1 after submission for this code...
